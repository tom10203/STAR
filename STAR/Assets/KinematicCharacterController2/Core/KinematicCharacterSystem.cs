...
{
    /// <summary>
    /// The system that manages the simulation of KinematicCharacterMotor2 and PhysicsMover
    /// </summary>
    ...
    public class KinematicCharacterSystem : MonoBehaviour
    {
        ...
        public static List<KinematicCharacterMotor2> CharacterMotors = new List<KinematicCharacterMotor2>();
        ...
        /// <summary>
        /// Registers a KinematicCharacterMotor2 into the system
        /// </summary>
        public static void RegisterCharacterMotor(KinematicCharacterMotor2 motor)
        {
            CharacterMotors.Add(motor);
        }

        /// <summary>
        /// Unregisters a KinematicCharacterMotor2 from the system
        /// </summary>
        public static void UnregisterCharacterMotor(KinematicCharacterMotor2 motor)
        {
        ...
        /// <summary>
        /// Remembers the point to interpolate from for KinematicCharacterMotor2s and PhysicsMovers
        /// </summary>
        public static void PreSimulationInterpolationUpdate(float deltaTime)
        {
            ...
            {
                KinematicCharacterMotor2 motor = CharacterMotors[i];
        ...
        /// </summary>
        public static void Simulate(float deltaTime, List<KinematicCharacterMotor2> motors, List<PhysicsMover> movers)
        {
...
#pragma warning disable 0162
            ...
            for (int i = 0; i < characterMotorsCount; i++)
            {
                KinematicCharacterMotor2 motor = motors[i];
...
#pragma warning restore 0162
        ...
        /// <summary>
        /// Initiates the interpolation for KinematicCharacterMotor2s and PhysicsMovers
        /// </summary>
