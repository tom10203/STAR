...
namespace KinematicCharacterController2
{
    ...
    /// </summary>
    [System.Serializable]
    public struct KinematicCharacterMotor2State
    {
    ...
    public class KinematicCharacterMotor2 : MonoBehaviour
    {
...
#pragma warning restore 0414 
        ...
        /// </summary>
        public KinematicCharacterMotor2State GetState()
        {
            KinematicCharacterMotor2State state = new KinematicCharacterMotor2State();
        ...
        /// </summary>
        public void ApplyState(KinematicCharacterMotor2State state, bool bypassInterpolation = true)
        {
        ...
        private void StoreRigidbodyHit(Rigidbody hitRigidbody, Vector3 hitVelocity, Vector3 hitPoint, Vector3 obstructionNormal, HitStabilityReport hitStabilityReport)
        {
            ...
            {
                if (!hitRigidbody.GetComponent<KinematicCharacterMotor2>())
                {
            ...
            for (int i = 0; i < _rigidbodyProjectionHitCount; i++)
            {
                ...
                if (bodyHit.Rigidbody && !_rigidbodiesPushedThisMove.Contains(bodyHit.Rigidbody))
                {
                    if (_internalRigidbodyProjectionHits[i].Rigidbody != _attachedRigidbody)
                    {
                        ...
                        KinematicCharacterMotor2 hitCharacterMotor = bodyHit.Rigidbody.GetComponent<KinematicCharacterMotor2>();
